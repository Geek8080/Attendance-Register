...
//import resources.classes.Utilities;
...
public class AlertMaker {
    ...
    public static void showMaterialDialog(StackPane root, Node nodeToBeBlurred, List<JFXButton> controls, String header, String body) {
        ...
        if (controls.isEmpty()||controls.equals(null)) {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(Main.ICON_IMAGE_LOC));
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("theme.css").toExternalForm());
